...
```{r}
png(paste0(main_dir, "petal_length_width.png"))
...
```{r}
png(paste0(main_dir, "petal_length_sepal_width.png"))
...
#plot the result
png(paste0(main_dir, "three_cluster_output_kmeans.png"))
ggplot(iris, aes(x=Petal.Length, y=Petal.Width)) +
...
#plot the result
png(paste0(main_dir, "five_cluster_output_kmeans.png"))
ggplot(iris, aes(x=Petal.Length, y=Petal.Width)) +
  geom_point(aes(color=kmeans_cluster))
graphics.off()
...
main_dir <- "/Users/bertozzivill/repos/infx572_winter17/module_10/part_1/"
...
png(paste0(main_dir, "knn_predict_10.png"))
...
#plot results
png(paste0(main_dir, "knn_predict_75.png"))
ggplot(testing_set, aes(x=Petal.Length, y=Petal.Width)) +
  geom_point(aes(color=Species), size=5, alpha=0.3) +
  geom_point(aes(color=predicted_species)) +
  geom_point(data=training_set, aes(color=Species), alpha=0.4, shape=2) +
