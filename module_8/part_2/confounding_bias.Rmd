...
Does this mean that we simply can't use regression methods to assess nonlinear relationships? But so many things follow a nonlinear pattern-- population size, income, country's GDP... can we never analyze these variables?
