...
The `Estimate` column gives us the estimated $\beta$ value for that variable. This is analogous to the simple output we see when we run `print(regression_output)`. 
