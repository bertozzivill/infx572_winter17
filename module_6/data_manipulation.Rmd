...
```
<br>
**Question 1**: How would you delete that column in the dataset?
...
You can use `i` and `j` in isolation, or with each other. `by`, again, always needs `j`. Below are some example commands. Do you understand what they do? 
